...
//based on example on tutorialspoint.com/How-to-stop-form-submission
function myValidation() {
  if (typeof POST['purchase_submit_button'] != 'undefined') {
    ...
    alert("Oops! Please select valid quantities!");
...
function isNonNegInt(num_puppies, return_errors = false) {
  ...
  if (num_puppies < 0) errors.push('<font color="red">Please put positive number!</font>'); // Check if it is non-negative
  if (parseInt(num_puppies) != num_puppies) errors.push('<font color="red">Please put number value!</font>'); // Check that it is an integer
